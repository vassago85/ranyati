...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #3a1208, #1a0c06); padding: 32px 32px 24px; text-align: center; }
        .header img { height: 32px; width: auto; }
        .body { padding: 32px; }
        .code { font-size: 36px; font-weight: 800; letter-spacing: 8px; text-align: center; color: #C45A3C; padding: 20px; background: #fdf2ef; border-radius: 8px; margin: 20px 0; font-family: monospace; }
...
<body>
    <div class="container">
        <div class="header">
            <img src="{{ asset('logo-ranyati_arms-white_text.png') }}" alt="Ranyati Arms" />
        </div>
        <div class="body">
