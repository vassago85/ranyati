...
<body>
    <div class="container">
        ...
        <div class="body">
            <h2 style="margin:0 0 8px;font-size:18px;color:#1a1a2e;">Verify your account</h2>
            <p style="color:#666;font-size:14px;">Enter this code to verify your Ranyati Motivations account and start receiving daily SAPS application updates:</p>
