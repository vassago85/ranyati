...
@section('content')
    ...
    <p>For motivations enquiries, use the <a href="https://motivations.ranyati.co.za/enquire">Motivations enquiry form</a>. For NRAPA membership, use <a href="https://nrapa.ranyati.co.za">nrapa.ranyati.co.za</a>. For storage, email <a href="mailto:info@firearmmotivations.co.za">info@firearmmotivations.co.za</a> or call <a href="tel:+27871510987">+27 87 151 0987</a>.</p>

    <div class="seo-cta">
        <p style="margin:0;font-size:14px;color:rgba(255,255,255,0.5);">Return to the group homepage</p>
        <a href="/">Ranyati Group home</a>
    </div>
@endsection
