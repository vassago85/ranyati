...
<a href="/firearm-licence-renewal-south-africa" class="{{ request()->is('firearm-licence-renewal-south-africa') ? 'active' : '' }}">Licence renewal</a>
<a href="/firearm-licence-appeal-south-africa" class="{{ request()->is('firearm-licence-appeal-south-africa') ? 'active' : '' }}">Licence appeals</a>
<a href="/faq" class="{{ request()->is('faq') ? 'active' : '' }}">Motivations FAQ</a>
<a href="/resources/firearm-licence-process">Licence process (resources)</a>
