...
@section('cta_text', 'A firearm licence application requires more than forms — it requires a properly structured, SAPS-compliant motivation. Ranyati helps you approach the process correctly from the start.')
